...
// Function: sub_0024A150
// Address: 0x24a150 - 0x24a1a8
void sub_0024A150_0x24a150(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_0024A150_0x24a150");
#endif

    ctx->pc = 0x24a150u;

    // 0x24a150: 0x68a30007  ldl         $v1, 0x7($a1)
    ctx->pc = 0x24a150u;
    ...
    // 0x24a154: 0x6ca30000  ldr         $v1, 0x0($a1)
    ctx->pc = 0x24a154u;
    ...
    // 0x24a158: 0x68a6000f  ldl         $a2, 0xF($a1)
    ctx->pc = 0x24a158u;
    ...
    // 0x24a15c: 0x6ca60008  ldr         $a2, 0x8($a1)
    ctx->pc = 0x24a15cu;
    ...
    // 0x24a160: 0x68a70017  ldl         $a3, 0x17($a1)
    ctx->pc = 0x24a160u;
    ...
    // 0x24a164: 0x6ca70010  ldr         $a3, 0x10($a1)
    ctx->pc = 0x24a164u;
    ...
    // 0x24a168: 0x68a8001f  ldl         $t0, 0x1F($a1)
    ctx->pc = 0x24a168u;
    ...
    // 0x24a16c: 0x6ca80018  ldr         $t0, 0x18($a1)
    ctx->pc = 0x24a16cu;
    ...
    // 0x24a170: 0xb0830007  sdl         $v1, 0x7($a0)
    ctx->pc = 0x24a170u;
    ...
    // 0x24a174: 0xb4830000  sdr         $v1, 0x0($a0)
    ctx->pc = 0x24a174u;
    ...
    // 0x24a178: 0xb086000f  sdl         $a2, 0xF($a0)
    ctx->pc = 0x24a178u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 15); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 6); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x24a17c: 0xb4860008  sdr         $a2, 0x8($a0)
    ctx->pc = 0x24a17cu;
    ...
    // 0x24a180: 0xb0870017  sdl         $a3, 0x17($a0)
    ctx->pc = 0x24a180u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 23); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 7); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x24a184: 0xb4870010  sdr         $a3, 0x10($a0)
    ctx->pc = 0x24a184u;
    ...
    // 0x24a188: 0xb088001f  sdl         $t0, 0x1F($a0)
    ctx->pc = 0x24a188u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 31); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 8); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x24a18c: 0xb4880018  sdr         $t0, 0x18($a0)
    ctx->pc = 0x24a18cu;
    ...
    // 0x24a190: 0x8ca30020  lw          $v1, 0x20($a1)
    ctx->pc = 0x24a190u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 5), 32)));
    // 0x24a194: 0x24020001  addiu       $v0, $zero, 0x1
    ctx->pc = 0x24a194u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    // 0x24a198: 0xac830020  sw          $v1, 0x20($a0)
    ctx->pc = 0x24a198u;
    WRITE32(ADD32(GPR_U32(ctx, 4), 32), GPR_U32(ctx, 3));
    // 0x24a19c: 0x3e00008  jr          $ra
    ctx->pc = 0x24A19Cu;
    {
        const uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x24A1A0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x24A19Cu;
        // 0x24a1a0: 0xac820024  sw          $v0, 0x24($a0) (Delay Slot)
        WRITE32(ADD32(GPR_U32(ctx, 4), 36), GPR_U32(ctx, 2));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x24A19Cu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
