...
// Function: sub_00311B88
// Address: 0x311b88 - 0x311be0
void sub_00311B88_0x311b88(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_00311B88_0x311b88");
#endif

    ctx->pc = 0x311b88u;

    // 0x311b88: 0x3c02003f  lui         $v0, 0x3F
    ctx->pc = 0x311b88u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)63 << 16));
    // 0x311b8c: 0x3c03003f  lui         $v1, 0x3F
    ctx->pc = 0x311b8cu;
    SET_GPR_S32(ctx, 3, (int32_t)((uint32_t)63 << 16));
    // 0x311b90: 0x2449f850  addiu       $t1, $v0, -0x7B0
    ctx->pc = 0x311b90u;
    SET_GPR_S32(ctx, 9, (int32_t)ADD32(GPR_U32(ctx, 2), 4294965328));
    // 0x311b94: 0x68860007  ldl         $a2, 0x7($a0)
    ctx->pc = 0x311b94u;
    ...
    // 0x311b98: 0x6c860000  ldr         $a2, 0x0($a0)
    ctx->pc = 0x311b98u;
    ...
    // 0x311b9c: 0x6887000f  ldl         $a3, 0xF($a0)
    ctx->pc = 0x311b9cu;
    ...
    // 0x311ba0: 0x6c870008  ldr         $a3, 0x8($a0)
    ctx->pc = 0x311ba0u;
    ...
    // 0x311ba4: 0xb1260007  sdl         $a2, 0x7($t1)
    ctx->pc = 0x311ba4u;
    ...
    // 0x311ba8: 0xb5260000  sdr         $a2, 0x0($t1)
    ctx->pc = 0x311ba8u;
    ...
    // 0x311bac: 0xb127000f  sdl         $a3, 0xF($t1)
    ctx->pc = 0x311bacu;
    ...
    // 0x311bb0: 0xb5270008  sdr         $a3, 0x8($t1)
    ctx->pc = 0x311bb0u;
    ...
    // 0x311bb4: 0x2467f860  addiu       $a3, $v1, -0x7A0
    ctx->pc = 0x311bb4u;
    SET_GPR_S32(ctx, 7, (int32_t)ADD32(GPR_U32(ctx, 3), 4294965344));
    // 0x311bb8: 0x68a20007  ldl         $v0, 0x7($a1)
    ctx->pc = 0x311bb8u;
    ...
    // 0x311bbc: 0x6ca20000  ldr         $v0, 0x0($a1)
    ctx->pc = 0x311bbcu;
    ...
    // 0x311bc0: 0x68a4000f  ldl         $a0, 0xF($a1)
    ctx->pc = 0x311bc0u;
    ...
    // 0x311bc4: 0x6ca40008  ldr         $a0, 0x8($a1)
    ctx->pc = 0x311bc4u;
    ...
    // 0x311bc8: 0xb0e20007  sdl         $v0, 0x7($a3)
    ctx->pc = 0x311bc8u;
    ...
    // 0x311bcc: 0xb4e20000  sdr         $v0, 0x0($a3)
    ctx->pc = 0x311bccu;
    ...
    // 0x311bd0: 0xb0e4000f  sdl         $a0, 0xF($a3)
    ctx->pc = 0x311bd0u;
    ...
    // 0x311bd4: 0xb4e40008  sdr         $a0, 0x8($a3)
    ctx->pc = 0x311bd4u;
    ...
    // 0x311bd8: 0x3e00008  jr          $ra
    ctx->pc = 0x311BD8u;
    {
        const uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x311BD8u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
