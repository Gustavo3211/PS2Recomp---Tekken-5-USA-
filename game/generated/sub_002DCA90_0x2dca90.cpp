...
// Function: sub_002DCA90
// Address: 0x2dca90 - 0x2dcae8
void sub_002DCA90_0x2dca90(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_002DCA90_0x2dca90");
#endif

    ctx->pc = 0x2dca90u;

    // 0x2dca90: 0x68a20007  ldl         $v0, 0x7($a1)
    ctx->pc = 0x2dca90u;
    ...
    // 0x2dca94: 0x6ca20000  ldr         $v0, 0x0($a1)
    ctx->pc = 0x2dca94u;
    ...
    // 0x2dca98: 0x68a3000f  ldl         $v1, 0xF($a1)
    ctx->pc = 0x2dca98u;
    ...
    // 0x2dca9c: 0x6ca30008  ldr         $v1, 0x8($a1)
    ctx->pc = 0x2dca9cu;
    ...
    // 0x2dcaa0: 0x68a60017  ldl         $a2, 0x17($a1)
    ctx->pc = 0x2dcaa0u;
    ...
    // 0x2dcaa4: 0x6ca60010  ldr         $a2, 0x10($a1)
    ctx->pc = 0x2dcaa4u;
    ...
    // 0x2dcaa8: 0x68a7001f  ldl         $a3, 0x1F($a1)
    ctx->pc = 0x2dcaa8u;
    ...
    // 0x2dcaac: 0x6ca70018  ldr         $a3, 0x18($a1)
    ctx->pc = 0x2dcaacu;
    ...
    // 0x2dcab0: 0xb0820007  sdl         $v0, 0x7($a0)
    ctx->pc = 0x2dcab0u;
    ...
    // 0x2dcab4: 0xb4820000  sdr         $v0, 0x0($a0)
    ctx->pc = 0x2dcab4u;
    ...
    // 0x2dcab8: 0xb083000f  sdl         $v1, 0xF($a0)
    ctx->pc = 0x2dcab8u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 15); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 3); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x2dcabc: 0xb4830008  sdr         $v1, 0x8($a0)
    ctx->pc = 0x2dcabcu;
    ...
    // 0x2dcac0: 0xb0860017  sdl         $a2, 0x17($a0)
    ctx->pc = 0x2dcac0u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 23); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 6); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x2dcac4: 0xb4860010  sdr         $a2, 0x10($a0)
    ctx->pc = 0x2dcac4u;
    ...
    // 0x2dcac8: 0xb087001f  sdl         $a3, 0x1F($a0)
    ctx->pc = 0x2dcac8u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 31); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 7); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x2dcacc: 0xb4870018  sdr         $a3, 0x18($a0)
    ctx->pc = 0x2dcaccu;
    ...
    // 0x2dcad0: 0x68a20027  ldl         $v0, 0x27($a1)
    ctx->pc = 0x2dcad0u;
    ...
    // 0x2dcad4: 0x6ca20020  ldr         $v0, 0x20($a1)
    ctx->pc = 0x2dcad4u;
    ...
    // 0x2dcad8: 0xb0820027  sdl         $v0, 0x27($a0)
    ctx->pc = 0x2dcad8u;
    { uint32_t addr = ADD32(GPR_U32(ctx, 4), 39); uint32_t aligned_addr = addr & ~7u; uint32_t offset = addr & 7u; uint32_t shift = (7u - offset) << 3; uint64_t mask = 0xFFFFFFFFFFFFFFFFull >> shift; uint64_t old_data = READ64(aligned_addr); uint64_t val = GPR_U64(ctx, 2); uint64_t new_data = (old_data & ~mask) | ((val >> shift) & mask); WRITE64(aligned_addr, new_data); }
    // 0x2dcadc: 0x3e00008  jr          $ra
    ctx->pc = 0x2DCADCu;
    {
        const uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x2DCAE0u;
        ctx->in_delay_slot = true;
        ctx->branch_pc = 0x2DCADCu;
        // 0x2dcae0: 0xb4820020  sdr         $v0, 0x20($a0) (Delay Slot)
        ...
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x2DCADCu, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
