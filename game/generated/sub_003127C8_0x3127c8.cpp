...
// Function: sub_003127C8
// Address: 0x3127c8 - 0x312820
void sub_003127C8_0x3127c8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef PS2_FUNCTION_LOG_TRACKER
    PS_LOG_ENTRY("sub_003127C8_0x3127c8");
#endif

    ctx->pc = 0x3127c8u;

    // 0x3127c8: 0x3c02003f  lui         $v0, 0x3F
    ctx->pc = 0x3127c8u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)63 << 16));
    // 0x3127cc: 0x3c03003f  lui         $v1, 0x3F
    ctx->pc = 0x3127ccu;
    SET_GPR_S32(ctx, 3, (int32_t)((uint32_t)63 << 16));
    // 0x3127d0: 0x2449f870  addiu       $t1, $v0, -0x790
    ctx->pc = 0x3127d0u;
    SET_GPR_S32(ctx, 9, (int32_t)ADD32(GPR_U32(ctx, 2), 4294965360));
    // 0x3127d4: 0x68860007  ldl         $a2, 0x7($a0)
    ctx->pc = 0x3127d4u;
    ...
    // 0x3127d8: 0x6c860000  ldr         $a2, 0x0($a0)
    ctx->pc = 0x3127d8u;
    ...
    // 0x3127dc: 0x6887000f  ldl         $a3, 0xF($a0)
    ctx->pc = 0x3127dcu;
    ...
    // 0x3127e0: 0x6c870008  ldr         $a3, 0x8($a0)
    ctx->pc = 0x3127e0u;
    ...
    // 0x3127e4: 0xb1260007  sdl         $a2, 0x7($t1)
    ctx->pc = 0x3127e4u;
    ...
    // 0x3127e8: 0xb5260000  sdr         $a2, 0x0($t1)
    ctx->pc = 0x3127e8u;
    ...
    // 0x3127ec: 0xb127000f  sdl         $a3, 0xF($t1)
    ctx->pc = 0x3127ecu;
    ...
    // 0x3127f0: 0xb5270008  sdr         $a3, 0x8($t1)
    ctx->pc = 0x3127f0u;
    ...
    // 0x3127f4: 0x2467f880  addiu       $a3, $v1, -0x780
    ctx->pc = 0x3127f4u;
    SET_GPR_S32(ctx, 7, (int32_t)ADD32(GPR_U32(ctx, 3), 4294965376));
    // 0x3127f8: 0x68a20007  ldl         $v0, 0x7($a1)
    ctx->pc = 0x3127f8u;
    ...
    // 0x3127fc: 0x6ca20000  ldr         $v0, 0x0($a1)
    ctx->pc = 0x3127fcu;
    ...
    // 0x312800: 0x68a4000f  ldl         $a0, 0xF($a1)
    ctx->pc = 0x312800u;
    ...
    // 0x312804: 0x6ca40008  ldr         $a0, 0x8($a1)
    ctx->pc = 0x312804u;
    ...
    // 0x312808: 0xb0e20007  sdl         $v0, 0x7($a3)
    ctx->pc = 0x312808u;
    ...
    // 0x31280c: 0xb4e20000  sdr         $v0, 0x0($a3)
    ctx->pc = 0x31280cu;
    ...
    // 0x312810: 0xb0e4000f  sdl         $a0, 0xF($a3)
    ctx->pc = 0x312810u;
    ...
    // 0x312814: 0xb4e40008  sdr         $a0, 0x8($a3)
    ctx->pc = 0x312814u;
    ...
    // 0x312818: 0x3e00008  jr          $ra
    ctx->pc = 0x312818u;
    {
        const uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = jumpTarget;
        #if defined(PS2X_STRICT_RETURN_DIAGNOSTICS) && PS2X_STRICT_RETURN_DIAGNOSTICS
        (void)runtime->dispatchGuestBranch(rdram, ctx, jumpTarget, 0x312818u, 0u, PS2Runtime::GuestBranchKind::Return, "JR $ra");
        return;
        #else
        ctx->pc = jumpTarget;
        return;
